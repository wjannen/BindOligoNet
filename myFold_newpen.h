...
#define SINGLE_GAP_PENALTY 380 //if you just have 1 gap

/** Penalty for n-length bulge loop gaps (n<=6): MULTI_GAP_AFFINE + MULTI_GAP_PENALTY*n */
#define MULTI_GAP_AFFINE 200

/** Penalty for n-length bulge loop gaps (n<=6): MULTI_GAP_AFFINE + MULTI_GAP_PENALTY*n */
#define MULTI_GAP_PENALTY 40
